...
from .lc_av_types import LC_H3_PIPE, LC_H3_PIPE_V2, LC_PIPE, copy_shared_from_lc_pipe, meta_in
...
class LCSaveVideoMetadata:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "pipe": (
                    f"{LC_PIPE},{LC_H3_PIPE},{LC_H3_PIPE_V2}",
                    {
                        "tooltip": "LC123 LC_PIPE or MiniMax H3 Pipe / V2. Prompts/seed/steps/size only.",
                    },
                ),
                "av_pipe": (
                    PIPE_TYPE,
    ...
    DESCRIPTION = (
        ...
        "Wire to LC Save Image or LC Save Video. Pipe accepts LC_PIPE, LC MiniMax H3 Pipe / V2, "
        "or LC_AV_PIPE (av_pipe)."
    )
    ...
    def build(
        ...
        pos = txt(positive) or txt(pipe_get(pipe, "positive_prompt", "positive", "prompt"))
